...
public class ProductServiceTest {
	...
	@BeforeEach
	void setUp() {
		product = Product.builder().id(1L).name("Test Product").description("Test Description").price(99.99).build();

		productDTO = ProductDTO.builder().id(1L).name("Test Product").description("Test Description").price(99.99)
				.build();
	}
	...
	@Test
	void testFindByNullId_ExpectException() {
		ECommerceException exception = assertThrows(ECommerceException.class, () -> productService.findById(null));
